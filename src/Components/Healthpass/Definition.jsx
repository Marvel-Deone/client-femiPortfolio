const Definition = () => {
    return (
        <div
            className="w-full flex md:flex-row justify-between flex-col md:gap-10 gap-20 mx-auto bg-[#273C75] h-auto py-10 md:py-24 md:px-[6.25rem]">
            <div className="w-full md:w-2/5 px-3 md:px-0">
