const NextProject = () => {
    return (
        <div className="max-w-6xl flex flex-col gap-11 mx-auto p-3 md:px-20 mb-10 lg:mb-20 h-[10px] -translate-y-[10rem] md:-translate-y-[25rem]">
            ...
            <div className="flex flex-col md:flex-row gap-20">
                <div className="flex">
                    ...
                    <div className="bg-[#FFFFFF] shadow-lg rounded-l w-full md:w-[370px] px-10 py-6 hover:text-blue-700 transition-all duration-300 ease-in-out">
                        <a href="/airpeace-case-study"><span className="text-[#111111] hover:text-blue-700 transition-all duration-300 ease-in-out  text-[18px]">Air Peace</span></a>
                    </div>
                </div>
