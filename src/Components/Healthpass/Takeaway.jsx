const Takeaway = () => {
    return (
        <div className="w-full flex justify-between flex-col mx-auto text-black h-auto px-28 py-10 md:py-24">
            <h2 className="font-semibold leading-4 text-base">Takeaways</h2>
            <h2 className="text-[15px] mt-5">Who am i designing for ? and what challennpm nnnnges are
