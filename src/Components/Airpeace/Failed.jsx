const Failed = () => {
    return (
        <div
            ...
            <div className="max-w-7xl lg:px-24 flex flex-col gap-4 md:mb-2">
                <h2 className="text-[#AD1124] px-3 font-semibold leading-4 text-sm md:text-base mb-2 md:mb-0 text-center">We
                    failed to solve air travellers problem of booking a flight</h2>
                <p className="text-sm md:text-base px-3 text-[#111111] font-[400]">From the feedback we got from frequent air
                    travellers. we learnt
                </p>
            </div>
            <div className="md:px-6 lg:px-8 xl:px-14">
                <div className="bg-[#F5F4F3] p-6 lg:p-14">
