const SolutionPreview = () => {
    return (
        <div className="max-w-6xl mx-auto -translate-y-[10rem] mb-6 md:-translate-y-[12.5rem]">
            ...
            <div className="flex flex-col gap-8 md:gap-0">
                ...
                <div className="flex flex-col md:flex-row gap-3 md:gap-56">
                    <div className="md:hidden relative w-fit h-[28rem] md:h-[30rem] lg:h-[36rem] flex items-center px-2">
                    ...
                    <div className="flex flex-col my-auto gap-3 md:gap-12">
                        <h2 className="font-bold text-lg md:text-2xl text-[#111111]w-full md:w-[28rem] px-2">A ready to use app, all accessible from your mobile phone.
                        </h2>
                        <p className="text-base text-[#111111] font-[300] w-full md:w-[28rem] px-2">Whether a user wants to Book a Flight, view Flight Status, Check in or Manage Bookings. </p>
                    </div>
                </div>
                {/* List of departure */}
                ...
                <div className="flex flex-col md:flex-row gap-3 md:gap-64 px-2">
                    <div className="md:hidden relative w-fit h-[28rem] md:h-[36rem] flex">
                        <div className="rounded-full bg-[#E9F1FC] w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 flex my-auto">
                        </div>
                    ...
                    <div className="flex flex-col my-auto gap-3 md:gap-12">
                        <h2 className="font-bold text-lg md:text-2xl text-[#111111] w-full md:w-[28rem] px-1">View Upcoming Trip.
                        </h2>
                        <p className="text-base text-[#111111] font-[300] w-full md:w-[26rem] px-1">Air Travellers can view details of their next trip. from the date to the time and also the flight number.</p>
                    </div>
                </div>
            </div>
        </div>
