const FinalSol = () => {
    return (
        <div
            className="max-w-full bg-[#DCDDE1] -translate-y-[14rem] md:-translate-y-[15rem] md:py-16 p-6 lg:px-28 flex flex-col gap-16">
            <div className="max-w-7xl flex flex-col gap-2 md:px-8 lg:px-0 md:mb-2">
