        ...
        <div
            ...
            <div className="max-w-6xl mx-auto px-3 py-6 md:py-0 flex flex-col gap-7">
                ...
                <div className="flex flex-col gap-3">
                    <p className="text-sm md:text-[18px] leading-loose text-white font-[200]">In the past few years, the
                        Aviation sector
                        in Nigeria has
                    ...
                    <p className="text-white text-sm md:text-[18px] leading-loose font-[200]">
                    ...
                    <p className="text-white text-sm md:text-[18px] leading-loose font-[200] w-full md:w-[444px] border-b-2 border-blue-800">Here’s our initial “How Might We“ (HMW) Problem statement</p>
                </div>
            </div>
            <div className="max-w-6xl flex mx-auto px-3 py-10">
                <h2 className="text-white text-[16px] md:text-2xl text-extrabold">HMW encourage easy and seamless purchase of air
                    tickets
                    by
                    air
                    travellers and
